...
orgs.newOrg('automotive.timpani', 'eclipse-timpani') {
 ...
 _repositories+:: [
   ...
   orgs.newRepo('timpani26') {
        description: "Eclipse timpani provides Distributed real-time scheduling system with time-triggered execution capabilities  with AI Workload.",
        topics+: [
          "timpani",
          "automotive",
          "containers",
